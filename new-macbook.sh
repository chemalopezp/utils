...
#
#   5. You will be promted to fill out your git email and name. 
#      Use the email and name you use for Github
#  
#===============================================================================
...
Welcome to the Quick Setup script

Based on https://github.com/vendasta/setup-new-computer-script
...
# --------------------------------------------------------------------
# Begin Bash autogenerated content from new-macbook.sh   $VERSION
# --------------------------------------------------------------------
...
# --------------------------------------------------------------------
# End autogenerated content from new-macbook.sh   $VERSION
# --------------------------------------------------------------------
...
# --------------------------------------------------------------------
# Begin ZSH autogenerated content from new-macbook.sh   $VERSION
# --------------------------------------------------------------------
...
# --------------------------------------------------------------------
# Begin Husky autogenerated content from new-macbook.sh   $VERSION
# --------------------------------------------------------------------
...
printDivider
    echo "✔ Touch ~/.zprofile"
        touch ~/.zprofile
printDivider
    if grep --quiet "new-macbook.sh" ~/.bash_profile; then
...
printDivider
    # Zsh profile
    if grep --quiet "new-macbook.sh" ~/.zprofile; then
...
printHeading "Installing Applications"
    ...
    printStep "Asana"                       "brew install --cask asana"
    printStep "Hyper"                       "brew install --cask hyper"
...
printStep "oh-my-zsh"                   "sh -c "$(curl -fsSL https://raw.github.com/ohmyzsh/ohmyzsh/master/tools/install.sh)""
